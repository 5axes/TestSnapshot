...
# https://github.com/randellhodges/Cura-EmbedSnapshotPlugin
import numpy
...
class Snapshot:
    ...
    def snapshot(width = 300, height = 300):
        ...
        Logger.log("d", "render_width = %.4f, render_height = %.4f", render_width, render_height)
        ...
        Logger.log("d", "bbox width = %.4f, height = %.4f, depth = %.4f, size = %.4f", bbox.width, bbox.height, bbox.depth , size)
        ...
        scaled_image = pixel_output.scaled(width, height, aspectRatioMode = QtCore.Qt.KeepAspectRatio, transformMode = QtCore.Qt.SmoothTransformation)
